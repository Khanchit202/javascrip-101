...
export default function Home() {
  ...
  const navList = (
    <ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      ...
      >
        ...
        >
          <path
            d="M2 0.5C1.46957 0.5 0.960859 0.710714 0.585786 1.08579C0.210714 1.46086 0 1.96957 0 2.5V4.5C0 5.03043 0.210714 5.53914 0.585786 5.91421C0.960859 6.28929 1.46957 6.5 2 6.5H12C12.5304 6.5 13.0391 6.28929 13.4142 5.91421C13.7893 5.53914 14 5.03043 14 4.5V2.5C14 1.96957 13.7893 1.46086 13.4142 1.08579C13.0391 0.710714 12.5304 0.5 12 0.5H2ZM2 8.5C1.46957 8.5 0.960859 8.71071 0.585786 9.08579C0.210714 9.46086 0 9.96957 0 10.5V12.5C0 13.0304 0.210714 13.5391 0.585786 13.9142C0.960859 14.2893 1.46957 14.5 2 14.5H12C12.5304 14.5 13.0391 14.2893 13.4142 13.9142C13.7893 13.5391 14 13.0304 14 12.5V10.5C14 9.96957 13.7893 9.46086 13.4142 9.08579C13.0391 8.71071 12.5304 8.5 12 8.5H2Z"
            fill="#90A4AE"
          />
        </svg>
        <a href="#" className="flex items-center">
      ...
      >
        ...
        >
          <path
            fill-rule="evenodd"
            clip-rule="evenodd"
            d="M14.2 7.4C14.6538 7.4 15 7.74618 15 8.2C15 8.65382 14.6538 9 14.2 9H10.8C10.3462 9 10 8.65382 10 8.2C10 7.74618 10.3462 7.4 10.8 7.4H14.2ZM4 8.2C4 8.65382 3.65382 9 3.2 9H1.8C1.34618 9 1 8.65382 1 8.2C1 7.74618 1.34618 7.4 1.8 7.4H3.2C3.65382 7.4 4 7.74618 4 8.2ZM10 8.2C10 8.65382 9.65382 9 9.2 9H6.8C6.34618 9 6 8.65382 6 8.2C6 7.74618 6.34618 7.4 6.8 7.4H9.2C9.65382 7.4 10 7.74618 10 8.2ZM2 2.5C1.46957 2.5 0.960859 2.71071 0.585786 3.08579C0.210714 3.46086 0 3.96957 0 4.5V10.5C0 11.0304 0.210714 11.5391 0.585786 11.9142C0.960859 12.2893 1.46957 12.5 2 12.5H14C14.5304 12.5 15.0391 12.2893 15.4142 11.9142C15.7893 11.5391 16 11.0304 16 10.5V4.5C16 3.96957 15.7893 3.46086 15.4142 3.08579C15.0391 2.71071 14.5304 2.5 14 2.5H2Z"
            fill="#90A4AE"
          />
        </svg>
        <a href="#" className="flex items-center">
  ...
  return (
    <Navbar className="relative mx-auto max-w-screen-xl px-4 py-2 lg:px-8 lg:py-4">
